...
void usage(){
    fprintf(stderr, "Usage:\n stdin | ./aseqtl [OPTIONS]\n");
    fprintf(stderr, "     -i Y.bin \n");
    fprintf(stderr, "     [-w <Weight.bin (double)>]\n"); 
    fprintf(stderr, "     [-x <covariates>] \n");
    fprintf(stderr, "     -K [Row ID (start from 1) of Y]\n");
    fprintf(stderr, "     -M [N of eSNPs] \n");
    fprintf(stderr, "     -L [N of test SNPs]\n"); 
    fprintf(stderr, "     -N [sample size]\n");
}
